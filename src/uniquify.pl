...
uniquify.pl <file>
   ...
   -g <1/0>:   Group colums inorder to uniquify them together. Default is 0.Forexamle running: uniquify.pl <FILE> -c 1-3 -g 1 will treat coloumns 1-3 as one and uniquify their concatenation.   -f:         Force a number even on first occurrence
